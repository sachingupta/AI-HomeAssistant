...
- [Building Effective Agents (Anthropic Blog)](https://www.anthropic.com/research/building-effective-agents) — must-read for agent design patterns
...
1. Read [Building Effective Agents](https://www.anthropic.com/research/building-effective-agents) — 30 min
2. Complete [MCP Quickstart](https://modelcontextprotocol.io/quickstart) — build a hello-world MCP server
3. Read [Tool Use Guide](https://docs.anthropic.com/en/docs/build-with-claude/tool-use) — understand how Claude calls tools
4. Browse [MCP Server Examples](https://github.com/modelcontextprotocol/servers) — especially filesystem and Google Drive servers
5. Build the first MCP server for this project (Google Drive integration)
6. Layer in the multi-agent orchestration pattern
